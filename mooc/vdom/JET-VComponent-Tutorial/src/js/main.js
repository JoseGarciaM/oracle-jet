...
(function () {
  ...
  ,
        ...
        'oj-greet': 'jet-composites/oj-greet',
        'oj-tutorial': 'jet-composites/oj-tutorial',
        'oj-hello-world': 'jet-composites/oj-hello-world',
        'oj-demo-writeback': 'jet-composites/oj-demo-writeback',
        'oj-demo-unique-id': 'jet-composites/oj-demo-unique-id'
      }
      // endinjector
    }
  );
